...
# 凯旋门计划(凯旋杯): 剧本详情页(标题"逐星之旅凯旋门计划") / 选择养成模式
CULTIVATE_KAISEN_SCENARIO_DETAIL = UI("CULTIVATE_KAISEN_SCENARIO_DETAIL", [template.UI_SCENARIO_KAISEN], [])
CULTIVATE_KAISEN_MODE_SELECT = UI("CULTIVATE_KAISEN_MODE_SELECT", [template.UI_CULTIVATE_KAISEN_MODE_SELECT], [])
...
scan_ui_list = [MAIN_MENU,
                ...
                CULTIVATE_KAISEN_SCENARIO_DETAIL, CULTIVATE_KAISEN_MODE_SELECT,
