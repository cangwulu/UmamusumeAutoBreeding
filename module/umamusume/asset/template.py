...
# 凯旋门计划(凯旋杯): 选择养成模式界面(标题"选择养成模式")
UI_CULTIVATE_KAISEN_MODE_SELECT = Template("CULTIVATE_KAISEN_MODE_SELECT", UMAMUSUME_UI_TEMPLATE_PATH)
...
# 凯旋门计划: 标题在实机有动画/闪光特效, 阈值降到0.85(交叉匹配仅~0.15, 安全)
UI_SCENARIO_KAISEN = Template("SCENARIO_KAISEN", UMAMUSUME_SCENARIO_TEMPLATE_PATH,
                              ImageMatchConfig(match_accuracy=0.85))
...
UI_SCENARIO: dict[ScenarioType, Template] = {
    ...
    ScenarioType.SCENARIO_TYPE_KAISEN: UI_SCENARIO_KAISEN,
}
